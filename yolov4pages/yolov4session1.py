...
def yolov4app():
    st.header("yolov4 training model (12/12/2021)")
    '''
    model = "yolov4"
    ...
    '''
    path = r"C:\Users\User\Documents\ml_visualize\yolov4_training_log_resnet18.csv"
    ...
    if st.button("loss"):
        ...
        plt.grid(True)
        plt.savefig(r"C:\Users\User\Documents\ml_visualize\12_12_2021\loss.jpg")
        st.pyplot(fig)
    ...
    if st.button("validation loss"):
        ...
        plt.grid(True)
        ax.legend()
        plt.savefig(r"C:\Users\User\Documents\ml_visualize\12_12_2021\validation_loss.jpg")
        st.pyplot(fig)
    if st.button("mAP"):
        yAxis_name = "mAP"
        col_list = [yAxis_name]
        ...
        plt.grid(True)
        ax.legend()
        plt.savefig(r"C:\Users\User\Documents\ml_visualize\12_12_2021\mAP.jpg")
        st.pyplot(fig)
    if st.button("Training Parameters"):
        uploaded_file = open(r"C:\Users\User\Documents\yolo_v4_drone_train_resnet18_kitti_v2.txt","r")
